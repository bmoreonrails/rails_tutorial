...
{% protip %}
  Before you can complete the following list, your computer needs to be configured with Rails. If you haven't already, please refer to the [install instructions]({{ site.baseurl }}/installation.html) for list on configuring your computer.
{% endprotip %}
