...
{% list %}
  ...
  1.  Take a look at the `change` method. It has a `create_table` block that will create the `reviews` table.
...
{% list %}
  ...
  1.  If you didn't already, add this line to your migration.
...
{% list %}
  ...
  1.  Using the `Review` class, create two reviews.
...
{% list %}
  ...
  1.  Inside the `Review` class, add the following line.
